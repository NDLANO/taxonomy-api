...
public class NodesTest extends RestTest {
    ...
    public void update_and_clone_topic_resource_and_quality_evaluation_matches() throws Exception {
        { // Create structure with resources and quality evaluation
            builder.node(NodeType.SUBJECT, s1 -> s1.name("S1")
                    .publicId("urn:subject:1")
                    .child(NodeType.TOPIC, t1 -> t1.name("T1")
                            .publicId("urn:topic:1")
                            .child(NodeType.RESOURCE, r1 -> r1.name("R1")
                                    .publicId("urn:resource:1")
                                    .qualityEvaluation(Grade.Five))
                            .child(NodeType.RESOURCE, r2 -> r2.name("R2")
                                    .publicId("urn:resource:2")
                                    .qualityEvaluation(Grade.Four))
                            .child(NodeType.RESOURCE, r3 -> r3.name("R3")
        ...
        assertEquals(new GradeAverage(3.3, 3), topic2.getChildQualityEvaluationAverage().get());
        ...
        assertEquals(new GradeAverage(3.3, 6), subject1.getChildQualityEvaluationAverage().get());
    }
