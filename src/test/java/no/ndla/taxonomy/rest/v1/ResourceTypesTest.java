...
public class ResourceTypesTest extends RestTest {
    ...
    public void can_get_resourcetype_by_id() throws Exception {
        ...
        MockHttpServletResponse response =
                testUtils.getResource("/v1/resource-types/" + id.toString());
    ...
    public void can_get_resourcetype_by_id_with_translation() throws Exception {
        URI id =
                builder.resourceType(
                                rt -> rt.name("video").translation("nb", tr -> tr.name("film")))
                        .getPublicId();
    ...
    public void can_create_resourcetype() throws Exception {
        ResourceTypes.ResourceTypeCommand command =
                new ResourceTypes.ResourceTypeCommand() {
                    {
    ...
    public void can_change_resource_type_id() throws Exception {
        ...
        ResourceType result =
                resourceTypeRepository.getByPublicId(URI.create("urn:resourcetype:audiovideo"));
    ...
    public void can_update_parent_resourcetype() throws Exception {
        ...
        testUtils.updateResource(
                "/v1/resource-types/" + child.getPublicId(),
                new ResourceTypes.ResourceTypeCommand() {
                    {
    ...
    public void can_get_subtypes() throws Exception {
        ...
        MockHttpServletResponse response =
                testUtils.getResource("/v1/resource-types/" + id + "/subtypes");
        ResourceTypes.ResourceTypeIndexDocument[] subResourceTypes =
                testUtils.getObject(ResourceTypes.ResourceTypeIndexDocument[].class, response);
