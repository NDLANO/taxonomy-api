...
public class SubjectTranslationsTest extends RestTest {
    ...
    public void can_add_translation() throws Exception {
        ...
        testUtils.updateResource(
                "/v1/subjects/" + id + "/translations/nb",
    ...
    public void can_get_all_translations() throws Exception {
        ...
        SubjectTranslations.SubjectTranslationIndexDocument[] translations =
                testUtils.getObject(
    ...
    public void can_get_single_translation() throws Exception {
        ...
        SubjectTranslations.SubjectTranslationIndexDocument translation =
                testUtils.getObject(
                        SubjectTranslations.SubjectTranslationIndexDocument.class,
    ...
    public void can_get_topics_with_language() throws Exception {
        ...
        MockHttpServletResponse response =
                testUtils.getResource(
                        "/v1/subjects/" + subject.getPublicId() + "/topics?language=nb");
    ...
    public void can_get_translated_resources() throws Exception {
        ...
        MockHttpServletResponse response =
                testUtils.getResource("/v1/subjects/" + id + "/resources?language=nb");
        ...
        assertAllTrue(
                resources,
                r -> r.getResourceTypes().iterator().next().getName().equals("Artikkel"));
    }
