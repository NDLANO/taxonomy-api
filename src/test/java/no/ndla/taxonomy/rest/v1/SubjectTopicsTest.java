...
public class SubjectTopicsTest extends RestTest {
    ...
    public void can_add_topic_to_subject() throws Exception {
        ...
        URI id = getId(testUtils.createResource("/v1/subject-topics", new SubjectTopics.SubjectTopicPOST() {
            {
    ...
    public void cannot_add_existing_topic_to_subject() throws Exception {
        ...
        testUtils.createResource("/v1/subject-topics", new SubjectTopics.SubjectTopicPOST() {
            {
                this.subjectid = subjectId;
                this.topicid = topicId;
            }
    ...
    public void can_update_subject_rank() throws Exception {
        ...
        SubjectTopics.SubjectTopicDTO connection = testUtils.getObject(SubjectTopics.SubjectTopicDTO.class,
                responseBefore);
        assertEquals(0, connection.rank);

        testUtils.updateResource("/v1/subject-topics/" + id, new SubjectTopics.SubjectTopicPUT() {
            {
                primary = true;
                rank = 12;
            }
        ...
        SubjectTopics.SubjectTopicDTO connectionAfter = testUtils.getObject(SubjectTopics.SubjectTopicDTO.class,
                responseAfter);
    ...
    public void update_subject_rank_modifies_other_contiguous_ranks() throws Exception {
        ...
        testUtils.updateResource("/v1/subject-topics/" + updatedConnection.getPublicId().toString(),
                new SubjectTopics.SubjectTopicPUT() {
                    {
                        primary = true;
                        rank = 1;
                    }
        ...
        for (NodeConnection subjectTopic : subjectTopics) {
            ...
            SubjectTopics.SubjectTopicDTO connectionFromDb = testUtils.getObject(SubjectTopics.SubjectTopicDTO.class,
                    response);
    ...
    public void can_get_topics() throws Exception {
        ...
        SubjectTopics.SubjectTopicDTO[] subjectTopics = testUtils.getObject(SubjectTopics.SubjectTopicDTO[].class,
                response);
    ...
    public void can_get_subject_topic() throws Exception {
        ...
        SubjectTopics.SubjectTopicDTO subjectTopicIndexDocument = testUtils
                .getObject(SubjectTopics.SubjectTopicDTO.class, resource);
    ...
    public void topic_has_default_rank() throws Exception {
        ...
        MockHttpServletResponse response = testUtils.getResource("/v1/subject-topics");
        SubjectTopics.SubjectTopicDTO[] topics = testUtils.getObject(SubjectTopics.SubjectTopicDTO[].class, response);
    ...
    public void can_change_sorting_order_for_subtopics() throws Exception {
        ...
        testUtils.updateResource("/v1/topic-subtopics/" + tst1.getPublicId(), new SubjectTopics.SubjectTopicPUT() {
            {
                primary = true;
                rank = 2;
            }
        ...
        testUtils.updateResource("/v1/topic-subtopics/" + tst2.getPublicId(), new SubjectTopics.SubjectTopicPUT() {
            {
                primary = true;
                rank = 1;
            }
