...
public class RelevancesTest extends RestTest {
    ...
    public void can_get_a_single_relevance() throws Exception {
        ...
        MockHttpServletResponse response =
                testUtils.getResource("/v1/relevances/" + "urn:relevance:1");
        Relevances.RelevanceIndexDocument relevance =
                testUtils.getObject(Relevances.RelevanceIndexDocument.class, response);
    ...
    public void can_get_all_relevances() throws Exception {
        ...
        Relevances.RelevanceIndexDocument[] relevances =
                testUtils.getObject(Relevances.RelevanceIndexDocument[].class, response);
    ...
    public void duplicate_ids_not_allowed() throws Exception {
        Relevances.RelevanceCommand command =
                new Relevances.RelevanceCommand() {
                    {
