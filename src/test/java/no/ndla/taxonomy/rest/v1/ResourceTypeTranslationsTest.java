...
public class ResourceTypeTranslationsTest extends RestTest {
    ...
    public void can_get_all_resource_types() throws Exception {
        ...
        ResourceTypes.ResourceTypeIndexDocument[] resourceTypes =
                testUtils.getObject(ResourceTypes.ResourceTypeIndexDocument[].class, response);
    ...
    public void can_get_single_resource_type() throws Exception {
        URI id =
                builder.resourceType(
                                t -> t.name("Article").translation("nb", l -> l.name("Artikkel")))
                        .getPublicId();

        ResourceTypes.ResourceTypeIndexDocument resourceType =
                getResourceTypeIndexDocument(id, "nb");
    ...
    public void fallback_to_default_language() throws Exception {
        ...
        ResourceTypes.ResourceTypeIndexDocument resourceType =
                getResourceTypeIndexDocument(id, "XX");
    ...
    public void can_get_default_language() throws Exception {
        ...
        ResourceTypes.ResourceTypeIndexDocument resourceType =
                getResourceTypeIndexDocument(id, null);
        assertEquals("Article", resourceType.name);
    }
    ...
    public void can_add_translation() throws Exception {
        ...
        testUtils.updateResource(
                "/v1/resource-types/" + id + "/translations/nb",
    ...
    public void can_get_single_translation() throws Exception {
        ...
        ResourceTypeTranslations.ResourceTypeTranslationIndexDocument translation =
                testUtils.getObject(
                        ResourceTypeTranslations.ResourceTypeTranslationIndexDocument.class,
    ...
    private ResourceTypes.ResourceTypeIndexDocument getResourceTypeIndexDocument(
            URI id, String language) throws Exception {
        String path = "/v1/resource-types/" + id;
        if (isNotEmpty(language)) path = path + "?language=" + language;
        return testUtils.getObject(
                ResourceTypes.ResourceTypeIndexDocument.class, testUtils.getResource(path));
    }
}
