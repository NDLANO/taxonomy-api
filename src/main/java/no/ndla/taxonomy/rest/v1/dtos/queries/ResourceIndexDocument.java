...
public class ResourceIndexDocument {
    ...
    @ApiModelProperty(
            ...
            example = "[{\"id\":\"urn:resourcetype:learningPath\", \"name\":\"Learning path\"}]")
    ...
    @JsonProperty
    @ApiModelProperty(
            value = "All paths leading to this resource",
            example = "[\"/subject:1/topic:12/resource:12\", \"/subject:2/topic:13/resource:12\"]")
    ...
    public ResourceIndexDocument(Resource resource, String languageCode) {
        ...
        this.resourceTypes =
                resource.getResourceResourceTypes().stream()
                        ...
                        .map(
                                resourceType ->
                                        new ResourceTypeIndexDocument(resourceType, languageCode))
