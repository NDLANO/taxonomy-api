package no.ndla.taxonomy.rest.v1.command.topics;

import com.fasterxml.jackson.annotation.JsonProperty;
import io.swagger.annotations.ApiModelProperty;
import no.ndla.taxonomy.domain.Topic;
import no.ndla.taxonomy.rest.v1.CrudController;
 ...
 *
 */
public class CreateTopicCommand extends CrudController.CreateCommand<Topic> {
    @JsonProperty
