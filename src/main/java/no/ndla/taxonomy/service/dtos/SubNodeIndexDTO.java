...
public class SubNodeIndexDTO implements TopicTreeSorter.Sortable {
    @JsonProperty
    ...
    public SubNodeIndexDTO() {

    }

    public SubNodeIndexDTO(TopicSubtopic topicSubtopic, String language) {
