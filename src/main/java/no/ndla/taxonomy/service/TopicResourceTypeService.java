...
public class TopicResourceTypeService {
    ...
    @Transactional
    public List<TopicResourceType> getTopicResourceTypes(URI topicId) throws InvalidArgumentServiceException, NotFoundServiceException {
        if (topicId == null) {
    ...
    public URI addTopicResourceType(URI topicId, URI resourceTypeId) throws InvalidArgumentServiceException, NotFoundServiceException {
    ...
    public void deleteTopicResourceType(URI connectionId) throws InvalidArgumentServiceException, NotFoundServiceException {
