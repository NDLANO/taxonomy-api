...
public interface TopicSubtopicRepository extends TaxonomyRepository<TopicSubtopic> {
    ...
    @Query(
            "SELECT ts.topic.id AS topicId, ts.subtopic.id AS subtopicId, ts.rank AS rank"
    ...
    List<TopicSubtopic> findAllBySubtopicPublicIdIncludingTopicAndSubtopicAndCachedUrls(
            URI subTopicPublicId);
    ...
    List<TopicSubtopic> findAllByTopicPublicIdIncludingSubtopicAndSubtopicTranslations(
            URI publicId);
    ...
    List<TopicSubtopic> doFindAllBySubtopicIdIncludeTranslationsAndCachedUrlsAndFilters(
