...
public interface ResourceTypeRepository extends TaxonomyRepository<ResourceType> {
    ...
    List<ResourceType> findAllByParentIncludingTranslationsAndFirstLevelSubtypes(
            ResourceType parent);
    ...
    List<ResourceType> findAllByParentPublicIdIncludingTranslationsAndFirstLevelSubtypes(
            URI publicId);
}
