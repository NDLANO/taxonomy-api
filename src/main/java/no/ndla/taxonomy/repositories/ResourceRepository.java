...
public interface ResourceRepository extends TaxonomyRepository<Resource> {
    ...
    List<Resource> findAllByContentUriIncludingCachedUrlsAndResourceTypesAndFiltersAndTranslations(
            URI contentUri);
    ...
    @Query(
            "SELECT distinct r"
                    ...
                    + "   LEFT JOIN FETCH r.resourceTranslations"
                    + "   WHERE r.id IN (:idSet)")
    List<Resource> findByIdIncludingCachedUrlsAndResourceTypesAndFiltersAndTranslations(
            Collection<Integer> idSet);
    ...
    List<Resource> findByPublicIdIncludingCachedUrlsAndResourceTypesAndFiltersAndTranslations(
            Collection<URI> idSet);
