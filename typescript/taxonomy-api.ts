...
export enum ApiPaths {
    buildAverageTree = "/v1/admin/buildAverageTree",
    buildAverageTree_1 = "/v1/admin/buildAverageTree/{id}",
    buildAllContexts = "/v1/admin/buildContexts",
    getAllContexts = "/v1/contexts",
    createContext = "/v1/contexts",
    getAllContexts_1 = "/v1/contexts/",
    createContext_1 = "/v1/contexts/",
    deleteContext = "/v1/contexts/{id}",
    getAllNodeConnections = "/v1/node-connections",
    createNodeConnection = "/v1/node-connections",
    getAllNodeConnections_1 = "/v1/node-connections/",
    createNodeConnection_1 = "/v1/node-connections/",
    getNodeConnectionsPage = "/v1/node-connections/page",
    deleteEntity_7 = "/v1/node-connections/{id}",
    getNodeConnection = "/v1/node-connections/{id}",
    updateNodeConnection = "/v1/node-connections/{id}",
    getMetadata_5 = "/v1/node-connections/{id}/metadata",
    putMetadata_5 = "/v1/node-connections/{id}/metadata",
    getAllNodeResources = "/v1/node-resources",
    createNodeResource = "/v1/node-resources",
    getAllNodeResources_1 = "/v1/node-resources/",
    createNodeResource_1 = "/v1/node-resources/",
    getNodeResourcesPage = "/v1/node-resources/page",
    deleteEntity_6 = "/v1/node-resources/{id}",
    getNodeResource = "/v1/node-resources/{id}",
    updateNodeResource = "/v1/node-resources/{id}",
    getMetadata_4 = "/v1/node-resources/{id}/metadata",
    putMetadata_4 = "/v1/node-resources/{id}/metadata",
    getAllNodes = "/v1/nodes",
    createNode = "/v1/nodes",
    getAllNodes_1 = "/v1/nodes/",
    createNode_1 = "/v1/nodes/",
    getNodePage = "/v1/nodes/page",
    searchNodes = "/v1/nodes/search",
    searchNodes_1 = "/v1/nodes/search",
    deleteEntity_5 = "/v1/nodes/{id}",
    getNode = "/v1/nodes/{id}",
    updateNode = "/v1/nodes/{id}",
    cloneResource_1 = "/v1/nodes/{id}/clone",
    getAllConnections = "/v1/nodes/{id}/connections",
    getNodeFull = "/v1/nodes/{id}/full",
    makeResourcesPrimary_1 = "/v1/nodes/{id}/makeResourcesPrimary",
    getMetadata_3 = "/v1/nodes/{id}/metadata",
    putMetadata_3 = "/v1/nodes/{id}/metadata",
    getChildren = "/v1/nodes/{id}/nodes",
    publishNode = "/v1/nodes/{id}/publish",
    getResources = "/v1/nodes/{id}/resources",
    getAllNodeTranslations = "/v1/nodes/{id}/translations",
    getAllNodeTranslations_1 = "/v1/nodes/{id}/translations/",
    deleteNodeTranslation = "/v1/nodes/{id}/translations/{language}",
    getNodeTranslation = "/v1/nodes/{id}/translations/{language}",
    createUpdateNodeTranslation = "/v1/nodes/{id}/translations/{language}",
    contextByContextId = "/v1/queries/contextId",
    queryPath = "/v1/queries/path",
    queryResources = "/v1/queries/resources",
    queryTopics = "/v1/queries/topics",
    contextByContentURI = "/v1/queries/{contentURI}",
    getAllRelevances = "/v1/relevances",
    getAllRelevances_1 = "/v1/relevances/",
    getRelevance = "/v1/relevances/{id}",
    getAllRelevanceTranslations = "/v1/relevances/{id}/translations",
    getAllRelevanceTranslations_1 = "/v1/relevances/{id}/translations/",
    getRelevanceTranslation = "/v1/relevances/{id}/translations/{language}",
    getAllResourceResourceTypes = "/v1/resource-resourcetypes",
    createResourceResourceType = "/v1/resource-resourcetypes",
    getAllResourceResourceTypes_1 = "/v1/resource-resourcetypes/",
    createResourceResourceType_1 = "/v1/resource-resourcetypes/",
    deleteResourceResourceType = "/v1/resource-resourcetypes/{id}",
    getResourceResourceType = "/v1/resource-resourcetypes/{id}",
    getAllResourceTypes = "/v1/resource-types",
    createResourceType = "/v1/resource-types",
    getAllResourceTypes_1 = "/v1/resource-types/",
    createResourceType_1 = "/v1/resource-types/",
    deleteEntity_4 = "/v1/resource-types/{id}",
    getResourceType = "/v1/resource-types/{id}",
    updateResourceType = "/v1/resource-types/{id}",
    getResourceTypeSubtypes = "/v1/resource-types/{id}/subtypes",
    getAllResourceTypeTranslations = "/v1/resource-types/{id}/translations",
    getAllResourceTypeTranslations_1 = "/v1/resource-types/{id}/translations/",
    deleteResourceTypeTranslation = "/v1/resource-types/{id}/translations/{language}",
    getResourceTypeTranslation = "/v1/resource-types/{id}/translations/{language}",
    createUpdateResourceTypeTranslation = "/v1/resource-types/{id}/translations/{language}",
    getAllResources = "/v1/resources",
    createResource = "/v1/resources",
    getAllResources_1 = "/v1/resources/",
    createResource_1 = "/v1/resources/",
    getResourcePage = "/v1/resources/page",
    searchResources = "/v1/resources/search",
    deleteEntity_3 = "/v1/resources/{id}",
    getResource = "/v1/resources/{id}",
    updateResource = "/v1/resources/{id}",
    cloneResource = "/v1/resources/{id}/clone",
    getResourceFull = "/v1/resources/{id}/full",
    getMetadata_2 = "/v1/resources/{id}/metadata",
    putMetadata_2 = "/v1/resources/{id}/metadata",
    getResourceTypes = "/v1/resources/{id}/resource-types",
    getAllResourceTranslations = "/v1/resources/{id}/translations",
    getAllResourceTranslations_1 = "/v1/resources/{id}/translations/",
    deleteResourceTranslation = "/v1/resources/{id}/translations/{language}",
    getResourceTranslation = "/v1/resources/{id}/translations/{language}",
    createUpdateResourceTranslation = "/v1/resources/{id}/translations/{language}",
    getAllSubjectTopics = "/v1/subject-topics",
    createSubjectTopic = "/v1/subject-topics",
    getAllSubjectTopics_1 = "/v1/subject-topics/",
    createSubjectTopic_1 = "/v1/subject-topics/",
    getSubjectTopicPage = "/v1/subject-topics/page",
    deleteSubjectTopic = "/v1/subject-topics/{id}",
    getSubjectTopic = "/v1/subject-topics/{id}",
    updateSubjectTopic = "/v1/subject-topics/{id}",
    getAllSubjects = "/v1/subjects",
    createSubject = "/v1/subjects",
    getAllSubjects_1 = "/v1/subjects/",
    createSubject_1 = "/v1/subjects/",
    getSubjectPage = "/v1/subjects/page",
    searchSubjects = "/v1/subjects/search",
    deleteEntity_2 = "/v1/subjects/{id}",
    getSubject = "/v1/subjects/{id}",
    updateSubject = "/v1/subjects/{id}",
    getMetadata_1 = "/v1/subjects/{id}/metadata",
    putMetadata_1 = "/v1/subjects/{id}/metadata",
    getSubjectChildren = "/v1/subjects/{id}/topics",
    getAllSubjectTranslations = "/v1/subjects/{id}/translations",
    getAllSubjectTranslations_1 = "/v1/subjects/{id}/translations/",
    deleteSubjectTranslation = "/v1/subjects/{id}/translations/{language}",
    getSubjectTranslation = "/v1/subjects/{id}/translations/{language}",
    createUpdateSubjectTranslation = "/v1/subjects/{id}/translations/{language}",
    getSubjectResources = "/v1/subjects/{subjectId}/resources",
    getAllTopicResources = "/v1/topic-resources",
    createTopicResource = "/v1/topic-resources",
    getAllTopicResources_1 = "/v1/topic-resources/",
    createTopicResource_1 = "/v1/topic-resources/",
    getTopicResourcePage = "/v1/topic-resources/page",
    deleteTopicResource = "/v1/topic-resources/{id}",
    getTopicResource = "/v1/topic-resources/{id}",
    updateTopicResource = "/v1/topic-resources/{id}",
    getAllTopicSubtopics = "/v1/topic-subtopics",
    createTopicSubtopic = "/v1/topic-subtopics",
    getAllTopicSubtopics_1 = "/v1/topic-subtopics/",
    createTopicSubtopic_1 = "/v1/topic-subtopics/",
    getTopicSubtopicPage = "/v1/topic-subtopics/page",
    deleteTopicSubtopic = "/v1/topic-subtopics/{id}",
    getTopicSubtopic = "/v1/topic-subtopics/{id}",
    updateTopicSubtopic = "/v1/topic-subtopics/{id}",
    getAllTopics = "/v1/topics",
    createTopic = "/v1/topics",
    getAllTopics_1 = "/v1/topics/",
    createTopic_1 = "/v1/topics/",
    getTopicsPage = "/v1/topics/page",
    searchTopics = "/v1/topics/search",
    deleteEntity_1 = "/v1/topics/{id}",
    getTopic = "/v1/topics/{id}",
    updateTopic = "/v1/topics/{id}",
    getAllTopicConnections = "/v1/topics/{id}/connections",
    makeResourcesPrimary = "/v1/topics/{id}/makeResourcesPrimary",
    getMetadata = "/v1/topics/{id}/metadata",
    putMetadata = "/v1/topics/{id}/metadata",
    getTopicResources = "/v1/topics/{id}/resources",
    getTopicSubTopics = "/v1/topics/{id}/topics",
    getAllTopicTranslations = "/v1/topics/{id}/translations",
    getAllTopicTranslations_1 = "/v1/topics/{id}/translations/",
    deleteTopicTranslation = "/v1/topics/{id}/translations/{language}",
    getTopicTranslation = "/v1/topics/{id}/translations/{language}",
    createUpdateTopicTranslation = "/v1/topics/{id}/translations/{language}",
    getTaxonomyPathForUrl = "/v1/url/mapping",
    putTaxonomyNodeAndSubjectForOldUrl = "/v1/url/mapping",
    resolve = "/v1/url/resolve",
    getAllVersions = "/v1/versions",
    createVersion = "/v1/versions",
    getAllVersions_1 = "/v1/versions/",
    createVersion_1 = "/v1/versions/",
    deleteEntity = "/v1/versions/{id}",
    getVersion = "/v1/versions/{id}",
    updateVersion = "/v1/versions/{id}",
    publishVersion = "/v1/versions/{id}/publish"
}
