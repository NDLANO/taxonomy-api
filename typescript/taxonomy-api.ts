...
export type GradeAverageDto = components['schemas']['GradeAverageDTO'];
...
export type NodePost = components['schemas']['NodePOST'];
export type NodePut = components['schemas']['NodePUT'];
...
export type UpdateOrDeleteQualityEvaluationDto = components['schemas']['UpdateOrDeleteQualityEvaluationDTO'];
